                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="page-header card">
                                <div class="card-block">
                                    <h5 class="m-b-10">Lost Leads</h5>
                                    <ul class="breadcrumb-title b-t-default p-t-10">
                                        <li class="breadcrumb-item">
                                            <a href="index.php"> <i class="fa fa-home"></i> </a>
                                        </li>
                                       <li class="breadcrumb-item"><a href="#">Lost Leads</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- Page-header end -->
      ...
      <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" name="question5" id="question5" placeholder="Enter your answer" class="form-control">
                </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#lost_lead_list").DataTable({
            ...
            "order": [], 
            "ajax":{
                "url": "<?= base_url('leads/get_lost_leads_list'); ?>",
                "type": "POST"
                },
                "columnDefs":[
                    {
