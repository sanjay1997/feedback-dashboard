                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="page-header card">
                                <div class="card-block">
                                    <h5 class="m-b-10">Won Leads</h5>
                                    <ul class="breadcrumb-title b-t-default p-t-10">
                                        <li class="breadcrumb-item">
                                            <a href="index.php"> <i class="fa fa-home"></i> </a>
                                        </li>
                                       <li class="breadcrumb-item"><a href="#">Won Leads</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- Page-header end -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    <lable>4. If given the choice again today, would you still buy our product?</label><br>
...
<script>
    $(document).ready(function(){
        ...
        $("#won_lead_list").DataTable({
            ...
            "order": [], 
            "ajax":{
                "url": "<?= base_url('leads/get_won_leads_list'); ?>",
                "type": "POST"
                },
                "columnDefs":[
                    {
    ...
    function get_lead_data(lead_id,pr_id,zone){
        ...
        // var zone = '';
        // //Maharashtra, Dadra nagar Haveli, Gujarat, Goa, 
        // if (state_id == 20 || state_id == 7 || state_id == 11 || state_id == 10) {
        //     zone = 'wz';
        // }
        // else if(state_id == 1 || state_id == 4 || state_id == 3 || state_id == 15 || state_id == 21 || state_id == 22 || state_id == 23 || state_id == 25 || state_id == 29 || state_id == 31 || state_id == 34){
        //     zone = 'ez';
        // }
        // else if(state_id == 2 || state_id == 35){
        //     zone = 'cz1';
        // }
        // else if(state_id == 19 || state_id == 6){
        //     zone = 'cz2';
        // }
        // else if(state_id == 19 || state_id == 6){
        //     zone = 'cz2';
