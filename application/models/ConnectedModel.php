...
class ConnectedModel extends CI_Model
{
...
function get_connected_leads(){
    $this->_get_connected_leads_list_query();
    if($_POST['length'] != -1)
 ...
 private function _get_connected_leads_list_query(){
 ...
 function connected_leads_count_filtered(){
      $this->_get_connected_leads_list_query();
      $query = $this->db->get();
      return $query->num_rows();
  }

  public function connected_leads_count_all(){
